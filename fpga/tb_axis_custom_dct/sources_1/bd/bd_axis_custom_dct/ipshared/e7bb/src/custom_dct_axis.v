...
//        else begin
//            if (i_sync && !(m_axis_tvalid & m_axis_tready))
//                // input data, no output
//                packet_diff <= packet_diff + 1;
//            else if (i_sync && (m_axis_tvalid & m_axis_tready))
...
//        end
    ...
    always @(posedge aclk) begin
        if(!aresetn) begin
            ...
            if (packet_diff == 1 && (!i_sync && (m_axis_tvalid & m_axis_tready)))
    ...
    assign m_axis_tlast = m_axis_tlast_reg; // no eop indicators
